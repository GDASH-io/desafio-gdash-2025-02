...
class Producer:
    def __init__(self):
        self.base_url = "https://api.open-meteo.com/v1/forecast?latitude=-15.79&longitude=-47.88&current=temperature_2m,relative_humidity_2m,wind_speed_10m,precipitation_probability"
    ...
    def publish_weather_data(self, data):
        ...
        logging.info(f"📤 Dados enviados para fila: Temp={data['current']['temperature_2m']}°C, Umidade={data['current']['relative_humidity_2m']}%, Chuva={data['current']['precipitation_probability']}%")
